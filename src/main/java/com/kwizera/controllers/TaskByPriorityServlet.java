...
@WebServlet("/tasks/priority")
public class TaskByPriorityServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (projectId == null || InputValidationUtil.invalidURLParam(projectId)) {
            ...
            try {
                ...
                List<Task> tasks = taskServices.getTasksByPriority(projectIdParsed, TaskPriority.valueOf(priority));
